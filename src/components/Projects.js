...
export function Projects() {
  ...
  const projectsData = [
    {
      titleEn: "Semih's Pizza House",
      titleTr: "Semih'ın Pizza Evi",
      bodyEn:
      ...
      gitHubLink: "https://github.com/SemihAvc/fsweb-s7-challenge-pizza",
      vercelLink: "https://semihpizza.vercel.app/",
      projectImageURL:
