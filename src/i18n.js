...
const resources = {
  tr: {
    translation: {
      ...
      profile_birth_value: "11.11.1995",
      profile_city_value: "Adana",
      profile_education_value: "Uluslararası Kıbrıs Üniversitesi",
      profile_department_value: "Endüstri Mühendisliği",
      profile_graduation_value: "01.10.2021",
      profile_role_value: "Endüstri Mühendisi",
      ...
      about_me_text2:
        "Endüstri Mühendisliği alanında edindiğim teknik yeteneklerin yanı sıra çalışma yaşamının getirdiği softskills becerilerine de önem veriyor ve gelişimime katkı sunabilecek fırsatları araştırıyorum.",
  ...
  en: {
    translation: {
      ...
      profile_birth_value: "11.11.1995",
      profile_city_value: "Adana",
      profile_education_value: "Cyprus İnternational Univercity",
      profile_department_value: "Industrial Engineer",
      profile_graduation_value: "01.10.2021",
      profile_role_value: "Industrial Engineer",
      ...
      about_me_text2:
        "In addition to the technical skills I have gained in the field of Industrial Engineering, I also value the soft skills acquired through work experience and actively seek opportunities that can contribute to my personal development.",
